...
- Nel 2018 gli Enti "X" di Pordenone e Udine accorpano e viene costituito un unico Ente "X" con due sedi nei rispettivi capoluoghi (Pordenone e Udine), con conseguente necessità di integrare processi e _asset_, anche tecnologici.
...
L'Ente opta per dismettere le piattaforme client server ed effetuare il porting delle applicazioni sulla piattaforma web-based.

Il primo step di questo processo ha comportato un _refactoring_ della Intranet.
...
```
\
Dalla sede di Udine vengono generate relativamente poche richieste rispetto al numero degli utenti.<br>Questo conferma che la sede di Udine è ancora in una fase iniziale di adozione dello strumento.
...
```
\
L'andamento mensile delle richieste di Udine non ha avuto particolari picchi positivi o negativi.<br>Le richieste dalla sede di Pordenone presentano invece una variabiltà maggiore.
